...
#a
print("My {} would cost ${:,.0f}!".format(name, cost))  # str.format version
print(f"My {name} would cost ${cost:,.0f}!")  # preferred f-string version
...
# a.TODO: Use f-string formatting to produce the output:
# 1922 Gibson L-5 CES for about $16,036!

# b.TODO: Using a for loop with the range function and f-string formatting,
